...
function showHideCode(id){$("#"+id).toggle();}

function getid(){
var temp =$("meta[name='citation_technical_report_number']").attr("content"); 
//var temp = $("strong").text();
//var str = temp.substring(0,temp.length);
//alert(temp);
return temp;
...
$(function() {
var innerStr = $(".navtrailboxbody").html();
	if(innerStr=="\n   \n  ")
	{
		//$(".narrowandfocusonsearchbox").css("align","right");
		$(".narrowandfocusonsearchbox").attr("align", "right");
	}
});

$(function() {
var innerStr = $(".navtrailboxbody").html();
	var t = innerStr.indexOf('中国科学院');
	if(innerStr!="\n   \n  ")
	{
		if( t<0)
		{
			$(".showupdate").attr("style", "display:none");
		}
	}
});
